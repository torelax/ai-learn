...
| 文档 | 关系 |
|------|------|
| [LLM-DA文本行人检索数据增强详解.md](../LLM-DA-TPR/LLM-DA文本行人检索数据增强详解.md) | 另一条 LLM 数据增强（图文行人） |
| [ColPali详解.md](../ColPali/ColPali详解.md) / [ColQwen系列详解.md](../ColQwen/ColQwen系列详解.md) | 视觉文档检索；同属「视觉当页/段」 |
