...
| 文档 | 关系 |
|------|------|
| [NV-Retriever详解.md](NV-Retriever详解.md) | 负例过滤；与 TFF 同属「质量门」 |
| [难负例挖掘工业实践.md](难负例挖掘工业实践.md) | 工业闭环 |
| [DeVE-QA稠密视频事件问答详解.md](DeVE-QA稠密视频事件问答详解.md) | LLM 合成 QA 数据另一极 |
| [QZhou-Embedding详解.md](QZhou-Embedding详解.md) | 大规模 LLM 结构/语义/难负合成 |
