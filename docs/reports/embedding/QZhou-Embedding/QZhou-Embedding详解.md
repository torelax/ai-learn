...
> **refs**: [LLM2Vec](https://arxiv.org/abs/2404.05961) · [Echo](https://arxiv.org/abs/2402.15449) · [gte / gte-Qwen2](https://arxiv.org/abs/2308.03281) · [Token Prepending](../Token-Prepending/Token-Prepending详解.md)  
...
| **免训练层间注入** | **[Token Prepending](../Token-Prepending/Token-Prepending详解.md)** | 上一层 SET 写回句首 `<PST>` |
...
6. **因果问题**：若暂不能双向微调，可用 [Token Prepending](../Token-Prepending/Token-Prepending详解.md) 做零训练基线；要上检索 SOTA 仍建议走 QZhou 式双向。
