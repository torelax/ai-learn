...
> v1 深读：[Conan-embedding详解.md](../v1/Conan-embedding详解.md)（[arXiv:2408.15710](https://arxiv.org/abs/2408.15710)）。
...
v1（见 [Conan-embedding详解.md](../v1/Conan-embedding详解.md)）提出训中按难度替换（每 100 step；$1.15 S_i<S_0$ 且 $|S|<0.8$）；v2 **加重判定并改为逐步检查**。
