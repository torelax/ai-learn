...
> 本文把 **局部负例为何失效的方差分析、全局 ANN 难负例、异步索引刷新、与 DPR / BM25 对照、工业刷新节奏** 写全。工程闭环另见《[难负例挖掘工业实践](../难负例挖掘工业实践.md)》；假负例过滤的「正例锚定」见《[NV-Retriever详解](../NV-Retriever/NV-Retriever详解.md)》。
...
| [NV-Retriever详解.md](../NV-Retriever/NV-Retriever详解.md)             | 正例感知去假负；ANCE 的直接后继 |
| [Conan-embedding-v2详解.md](../Conan-embedding/v2/Conan-embedding-v2详解.md) | 动态池内替换                    |
| [E5详解.md](../E5/E5详解.md)                                 | 对比学习与监督微调公共祖先      |
| [ColBERTv2详解.md](../ColBERTv2/ColBERTv2详解.md)                   | 难负例 + CE 蒸馏另一路线        |
