...
| 文档 | 关系 |
| --- | --- |
| [E5详解.md](../E5/E5详解.md) | 弱监督对比前驱；GTE 相对它去掉过滤，mGTE 又把过滤加回多语数据 |
| [BGE-M3三功能统一详解报告.md](../BGE/M3/BGE-M3三功能统一详解报告.md) | mGTE 的直接对照：续训 XLM-R vs 从零 8K；稠密+稀疏同源 |
| [Nomic-Embed详解.md](../Nomic-Embed/Nomic-Embed详解.md) | 英文从零 8K RoPE 编码器；mGTE Figure 4 的对照曲线 |
| [LLM2Vec详解.md](../LLM2Vec/LLM2Vec详解.md) | Decoder 改双向的无监督配方；gte-Qwen2 是大数据有监督版 |
| [Conan-embedding详解.md](../Conan-embedding/v1/Conan-embedding详解.md) | 「遵循 Li et al. (2023a)」的两阶段引用来源 |
| [QZhou-Embedding详解.md](../QZhou-Embedding/QZhou-Embedding详解.md) | 双向 Qwen2.5 + 合成数据，GTE-Qwen 线的后继之一 |
