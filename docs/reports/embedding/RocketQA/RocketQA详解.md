...
> 本文把 **三大训练挑战、cross-batch 负例、CE 去噪难负例、伪标数据增强、四级火箭式课表、MS MARCO/NQ 结果，以及 v2 的动态 listwise 蒸馏** 写全。假负例后续演进见 [NV-Retriever详解.md](../NV-Retriever/NV-Retriever详解.md)；训中动态换负见 [Conan-embedding详解.md](../Conan-embedding/v1/Conan-embedding详解.md)（DHNM）；异步全库 ANN 见 [ANCE详解.md](../ANCE/ANCE详解.md)。
...
ColBERTv2 等「去噪蒸馏」同属这一代思路；学生换成 late-interaction 即见 [ColBERTv2详解.md](../ColBERTv2/ColBERTv2详解.md)。
...
| 文档 | 关系 |
|------|------|
| [ANCE详解.md](../ANCE/ANCE详解.md) | 全局 ANN；假负未滤 |
| [NV-Retriever详解.md](../NV-Retriever/NV-Retriever详解.md) | 正例锚定滤假负（RocketQA 后继） |
| [Conan-embedding详解.md](../Conan-embedding/v1/Conan-embedding详解.md) | DHNM：训中动态换负 |
| [ColBERTv2详解.md](../ColBERTv2/ColBERTv2详解.md) | 去噪蒸馏 → multi-vector 学生 |
