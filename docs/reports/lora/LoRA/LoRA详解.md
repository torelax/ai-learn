...
同目录可对照：`../../embedding/Conan-embedding/v2/Conan-embedding-v2详解.md`（LoRA vs 全参在嵌入场景的秩交互）、《Embedding蒸馏技术详解》等。**读 LoRA 原文 + 本文 §6–§7** 足以支撑 **7B–70B SFT/PEFT 方案设计**；**175B 级** 仍需结合 **分布式、QLoRA、数据规模** 单独论证。
